...
export const PageBuilder = ({ loadedPage, pageType, editedPageId }) => {
      ...
      >
        {({
          ...
          <Form noValidate onSubmit={handleSubmit}>
            ...
            <p>
              Wybierz elementy, które chcesz umieścić na stronie, a następnie je
              skonfiguruj.
            </p>
